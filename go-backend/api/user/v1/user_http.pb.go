...
const OperationUserGetVerifyCode = "/api.user.v1.User/GetVerifyCode"
...
func RegisterUserHTTPServer(s *http.Server, srv UserHTTPServer) {
	r := s.Route("/")
	r.GET("/api/v1/user/get-verify-code/{telephone}", _User_GetVerifyCode0_HTTP_Handler(srv))
}
...
func (c *UserHTTPClientImpl) GetVerifyCode(ctx context.Context, in *GetVerifyCodeRequest, opts ...http.CallOption) (*GetVerifyCodeReply, error) {
	...
	pattern := "/api/v1/user/get-verify-code/{telephone}"
